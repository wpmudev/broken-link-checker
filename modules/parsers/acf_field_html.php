...
/*
Plugin Name: ACF HTML
Description: Example : <code>&lt;a href="http://example.com/"&gt;link text&lt;/a&gt;</code>
Version: 1.0
Author: Janne Aaltogitg

ModuleID: acf_field_html
ModuleCategory: parser
ModuleClassName: blcACFHTMLParser
...
class blcACFHTMLParser extends blcParser {
	var $supported_formats = array('acf_field_html');
  ...
  /**
   * blcACFHTMLParser::parser_callback()
   *
   * @access private
   *
   * @param array $link
  ...
  /**
   * blcACFHTMLParser::unlink_callback()
   *
   * @access private
   *
   * @param array $link
 ...
 /**
  ...
  /**
   * Helper function for blcACFHTMLParser::multi_edit()
