...
<form class="search-form" action="<?php echo admin_url( 'tools.php?page=view-broken-links' ); ?>" method="get">
	...
	<input type="text" name="s_link_text" value="
	<?php
	if ( ! empty( $search_params['s_link_text'] ) ) {
		echo esc_attr( $search_params['s_link_text'] );}
	?>
	" id="s_link_text" class="text ui-widget-content" />
	
	<label for="s_link_url"><?php _e( 'URL', 'broken-link-checker' ); ?></label>
	<input type="text" name="s_link_url" id="s_link_url" value="
	<?php
	if ( ! empty( $search_params['s_link_url'] ) ) {
		echo esc_attr( $search_params['s_link_url'] );}
	?>
	" class="text ui-widget-content" />
	
	<label for="s_http_code"><?php _e( 'HTTP code', 'broken-link-checker' ); ?></label>
	<input type="text" name="s_http_code" id="s_http_code" value="
	<?php
	if ( ! empty( $search_params['s_http_code'] ) ) {
		echo esc_attr( $search_params['s_http_code'] );}
	?>
	" class="text ui-widget-content" />
