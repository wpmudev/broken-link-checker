    ...
    class wsBrokenLinkChecker
    {
        ...
        )
        {
            ...
            <p><label for="blc-autoexpand">
                    <input id="blc-autoexpand" name="blc-autoexpand" type="checkbox"
                           value="1" <?php if ($this->conf->options['autoexpand_widget']) echo 'checked="checked"'; ?> />
                                    ...
                                    <tr valign="top">
                                        ...
                                        <td>
                                            <p style="margin-top: 0; margin-bottom: 0.5em;">
                                                ...
                                                |
                                                <a id="toggle-broken-link-css-editor" href="#"
                                                   class="blc-toggle-link"><?php
		...
		*/
        ...
        function override_mail_content_type(/** @noinspection PhpUnusedParameterInspection */
            $content_type)
        {
            return 'text/html';
        }
